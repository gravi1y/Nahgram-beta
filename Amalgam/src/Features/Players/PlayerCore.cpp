...
void CPlayerlistCore::SavePlayerlist()
{
	...
	try
	{
		...
		SDK::Output("Nahgram", "Saved playerlist", { 175, 150, 255 }, OUTPUT_CONSOLE | OUTPUT_DEBUG | OUTPUT_TOAST | OUTPUT_MENU);
	}
	catch (...)
	{
		SDK::Output("Nahgram", "Save playerlist failed", { 175, 150, 255, 127 }, OUTPUT_CONSOLE | OUTPUT_DEBUG);
	}
}
...
void CPlayerlistCore::LoadPlayerlist()
{
	...
	try
	{
		...
		F::PlayerUtils.m_bLoad = false;
		SDK::Output("Nahgram", "Loaded playerlist", { 175, 150, 255 }, OUTPUT_CONSOLE | OUTPUT_DEBUG | OUTPUT_TOAST | OUTPUT_MENU);
	}
	catch (...)
	{
		SDK::Output("Nahgram", "Load playerlist failed", { 175, 150, 255, 127 }, OUTPUT_CONSOLE | OUTPUT_DEBUG);
	}
}