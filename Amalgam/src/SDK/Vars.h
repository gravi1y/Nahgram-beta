...
namespace Vars
{
	NAMESPACE_BEGIN(Menu)
		CVar(CheatTitle, "Cheat title", std::string("Nahgram"), VISUAL | DROPDOWN_AUTOUPDATE);
	CVar(CheatTag, "Cheat tag", std::string("[Nahgram]"), VISUAL);
	...
	CVar(AimFOV, "Aimbot FOV", 30.f, SLIDER_CLAMP | SLIDER_PRECISION, 0.f, 180.f);
